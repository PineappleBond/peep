...
**设计原则**：左侧列表为导航辅助（符合"左导航右内容"的常见布局），右侧盘面为核心展示区。

### 右侧：盘面区（核心展示）

**默认状态**：空状态，显示引导文案"请选择左侧列表中的记录查看盘面，或点击【新建起课】开始"

**展示状态**：用户点击左侧某条记录后，展示该记录的完整盘面：
